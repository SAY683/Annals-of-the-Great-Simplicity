...
| Threshold | Rationale |
|-----------|-----------|
| Benjamini-Hochberg `q=0.10` (exploratory) | `[C]` Standard FDR convention (Benjamini & Hochberg 1995); 0.10 (not 0.05) trades some false-discovery risk for power, appropriate for exploratory analysis. |
