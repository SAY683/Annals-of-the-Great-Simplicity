...
# ROUND27: 新增日期/时间单字（月/年/第/日/号/时/分/秒）和功能动词单字（称/说/看/问/答）
_CN_STOP_CHARS = set(
    ...
    "又也并而况且跟同与及以及除非若假使"
    "让令叫使被把给由在从向往朝到至于"
    # 日期/时间单字（jieba 常切出，因果价值为零）
    "月年第日号时分秒季周"
    # 功能动词单字（jieba 在新闻文体中常切出）
    "称说看问答论道云"
)
...
_CN_STOP_WORDS = {
    ...
    # ROUND27: 新闻文体常见功能词（因果价值低）
    "进而", "指出", "表示", "认为", "称将", "显示", "表明", "说明",
    "报道", "获悉", "了解", "透露", "证实", "否认", "回应", "强调",
    "当日", "当日", "此前", "近期", "届时", "目前", "随后", "此后",
    "此前", "同时", "其中", "此外", "另外", "值得注意",
    "引发", "导致", "造成", "带来", "促使", "推动", "影响",
    # 数量/程度
