...
## 5. VRAM 边界（当前模型：shehui-llama 27M / shenji-llama 469M / shehui-llama-v4-archive 470M）
...
> 以下表格基于历史 8M–50M 小模型，仅供旧模型参考。当前生产模型为 shehui-llama (27M 轻量) / shenji-llama (469M) / shehui-llama-v4-archive (470M 归档)，训练细节见模型训练日志。
